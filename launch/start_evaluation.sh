#!/usr/bin/env bash
# Complete runner for evaluating trained TurtleBot3 DQN Agent in Gazebo
...
# Run evaluation in rl_gazebo conda environment with system libstdc++ compatibility
export LD_PRELOAD=/usr/lib/x86_64-linux-gnu/libstdc++.so.6
PYTHON_BIN="/home/daniel/miniconda3/envs/rl_gazebo/bin/python"

cd "${WORKSPACE_DIR}"
echo "============================================================"
echo "🎯 Running PyTorch DQN Evaluation..."
echo "============================================================"
"${PYTHON_BIN}" -m gazebo_rl.evaluate "$@"
